...
"""State model for market researcher agent."""
...
class MarketResearchAgentState(BaseModel):
    """
    State for the market researcher agent subgraph.
    ...
    Attributes:
        ...
        research_scope: Optional hint about the research scope (e.g. competitive_analysis,
                        market_sizing, trend_analysis). Set by the intent classifier or caller.
    """
